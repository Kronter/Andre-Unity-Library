...
[CreateAssetMenu(fileName = "Mountain Layer", menuName = "Random Generation Layer/Mountain Layer")]
public class MountainGeneration : RandomGenerationLayer
{
    [Range(0,100)]
